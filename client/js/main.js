...
// socket = io.connect('http://127.0.0.1:2000', { reconnect: false });
...
function createSeatedPlayer(data) {
    ...
    player.drawRect(centerX, centerY, 80, 80);
    player.pivot.x = 40;
    player.pivot.y = 40;
    //player.anchor.setTo(0.5);

    //top row
    player.drawRect(centerX - 200, centerY - 200, 80, 80);
    text = game.add.text(centerX - 240, centerY - 260, 'Empty seat', style);

    player.drawRect(centerX + 0, centerY - 200, 80, 80);
    text = game.add.text(centerX - 40, centerY - 260, 'Empty seat', style);

    player.drawRect(centerX + 200, centerY - 200, 80, 80);
    text = game.add.text(centerX + 160, centerY - 260, 'Empty seat', style);

    //left
    player.drawRect(centerX - 330, centerY, 80, 80);
    text = game.add.text(centerX - 370, centerY - 60, 'Empty seat', style);
    //right
    player.drawRect(centerX + 330, centerY, 80, 80);
    text = game.add.text(centerX + 290, centerY - 60, 'Empty seat', style);

    // bottom row
    player.drawRect(centerX - 200, centerY + 200, 80, 80);
    text = game.add.text(centerX - 240, centerY + 240, 'Empty seat', style);
    player.drawRect(centerX + 0, centerY + 200, 80, 80);
    text = game.add.text(centerX - 40, centerY + 240, 'Empty seat', style);
    player.drawRect(centerX + 200, centerY + 200, 80, 80);
    text = game.add.text(centerX + 160, centerY + 240, 'Empty seat', style);
}
...
main.prototype = {
    preload: function() {
        ...
        game.load.image('poker_table', 'client/assets/img/poker_table.png');
    ...
    create: function() {
        ...
        game.stage.backgroundColor = 0x3f3c3d;

        poker_table = game.add.sprite(game.world.centerX, game.world.centerY, 'poker_table');
        poker_table.anchor.x = 0.5;
        poker_table.anchor.y = 0.5;
        poker_table.scale.setTo(0.3, 0.3);
